...
namespace project
{
    public partial class ShowMaterial : System.Web.UI.Page
    {
        ...
        {
            string uploadDirectory = Server.MapPath("~/Material_UploadedFiles/");
            ...
            if (files.Length > 0)
            {
                foreach (string file in files)
                {
                    ...
                    string downloadUrl = $"DownloadFile1.aspx?fileName={fileName}";
